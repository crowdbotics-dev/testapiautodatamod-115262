...
## Project Structure
    ...
    ├── testapiautodatamod_115262  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_115262`
...
2. Clone this repo and `cd testapiautodatamod_115262`
